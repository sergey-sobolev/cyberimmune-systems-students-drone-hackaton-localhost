...
- [Отчёт о выполнении задачи "Drone Atomizer"](#отчёт-о-выполнении-задачи-drone-atomizer)
  ...
  - [Архитектура решения](#архитектура-решения)
    ...
    - [Описание cценариев (последовательности выполнения операций), при которых ЦБ нарушаются\*](#описание-cценариев-последовательности-выполнения-операций-при-которых-цб-нарушаются)
      ...
      - [Негативный сценарий 4. Storage подменяет файл после проверки](#негативный-сценарий-4-storage-подменяет-файл-после-проверки)
...
![](hackaton/../out/algo2/algo2.png)

#### Негативный сценарий 3. Storage подменяет файл после проверки

![](hackaton/../out/algo3/algo3.png)

#### Негативный сценарий 4. Storage подменяет файл после проверки

![](hackcaton/../out/algo4/algo4.png)
